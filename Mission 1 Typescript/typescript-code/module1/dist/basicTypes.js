...
{ // Basic Data Types
    ...
    let str2 = 'I want to go home';
    console.log(str2);
    let day = 362025;
    let sad = true;
    let kobeBashayJabo = undefined;
    let ticketNai = null;
